...
export const GoogleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48">
        <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039L38.804 12.8C34.966 9.273 29.863 7 24 7C12.955 7 4 15.955 4 27s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"></path>
        <path fill="#FF3D00" d="M6.306 14.691l6.571 4.819C14.655 15.108 18.961 13 24 13c3.059 0 5.842 1.154 7.961 3.039L38.804 12.8C34.966 9.273 29.863 7 24 7C16.318 7 9.656 10.337 6.306 14.691z"></path>
        <path fill="#4CAF50" d="M24 47c5.863 0 10.966-2.273 14.804-5.895l-6.571-4.819C29.961 38.846 27.202 40 24 40c-5.045 0-9.351-3.108-11.124-7.489l-6.571 4.819C9.656 41.663 16.318 47 24 47z"></path>
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.571 4.819C40.049 34.398 44 28.537 44 20c0-1.341-.138-2.65-.389-3.917z"></path>
    </svg>
);